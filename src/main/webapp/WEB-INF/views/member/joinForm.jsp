	...
	<section class="writeForm">
		...
		<h1>회원가입</h1>
 		<input type="hidden" name="code" value="1">  
			<div class="int-area">
				<input type="text" name="name" id="name" width="20">
				<label for="name">USER_NAME</label>
			</div>
			<div class="int-area">
				<input type="text" name="id" id="id" width="20" >
				<label for="id">USER_ID</label>
				<input type="button" name="idDuplication" onclick="checkId()" value="중복 확인">
				<input type="hidden" id="check" name="check" value="f">
			</div>
			<div class="int-area">
				<input type="password" name="pw" id="pw" width="20">
				<label for="pw">password</label>
			</div>
			<div class="int-area">
				<input type="password" name="repw" id="repw" width="20">
				<label for="repw">password 확인</label>
				<input type="button" onclick="checkpw()" value="비밀번호 확인">
			...
			<div class="btn-area">
			<input type="button"  onclick="joinform_check()" value="회원가입"><br><br>
			<a href="${contextPath }/member/login">로그인</a><br><br>
